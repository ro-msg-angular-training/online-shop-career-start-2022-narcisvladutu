...
export const addProductFailure = createAction('[ADD Product] Add Product Failure', props<{ error: string }>());
...
export const getProductFailure = createAction('[GET Product] Get Product Failure', props<{ error: string }>());
...
export const updateProductFailure = createAction('[UPD Product] Update Product Failure', props<{ error: string }>());
...
export const deleteProductFailure = createAction('[DEL Product] Delete Product Failure', props<{ error: string }>());
